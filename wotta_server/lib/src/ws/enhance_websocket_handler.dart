...
class EnancheWebSocketHandler {
  ...
  EnancheWebSocketHandler(this._onConnection, this._protocols, this._allowedOrigins,
      this._pingInterval);
  ...
  Response handle(Request request ) {
    ...
    request.hijack((channel) {
      ...
      var webSocketChannel =  WebSocketChannel(channel, pingInterval: _pingInterval);

      Function.apply(
          _onConnection, [webSocketChannel, request]
      );
...
//typedef _TernaryFunction = void Function(Null, Null, Null);


Function enhanceWebSocketHandler(Function onConnection,
...
//  if (onConnection is! _TernaryFunction) {
//    if (protocols != null) {
...
//  }
  ...
  return EnancheWebSocketHandler(
